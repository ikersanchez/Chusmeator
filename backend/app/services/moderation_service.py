...
class ModerationService:
    ...
    async def check_text_for_pii(text: str) -> None:
        ...
        Analyze the following text and determine if it contains ANY Personal Identifiable Information (PII).
        PII includes, but is not limited to:
        - First names and surnames (unless they are clearly names of businesses or public places)
        - National ID numbers, passports, or social security numbers
        - Phone numbers
        - Exact personal addresses
        - Email addresses
        - Indirect references that can identify a specific person without naming them (e.g. 'the owner of this store sells...', 'the person living in this apartment is...', 'the teacher of this class...')

        Text to analyze:
        "{text}"

        Respond ONLY with a single boolean word: "YES" if the text contains PII, or "NO" if it is safe and free of PII.
        """
